...
export const CARD_SKINS: CardSkin[] = [
  ...
  },
  {
    ...
    border: 'linear-gradient(180deg, #F29E18, #EF4444, #F29E18)',
    glowColor: '#F29E18',
    background: '#0a0804',
    accent: '#F29E18',
    animated: true,
    overlay: `radial-gradient(circle at 25% 25%, rgba(242,158,24,0.08) 0%, transparent 40%), radial-gradient(circle at 75% 65%, rgba(239,68,68,0.06) 0%, transparent 35%)`,
    overlayOpacity: 1,
    innerBorder: '1px solid rgba(242,158,24,0.08)',
    headerGradient: 'linear-gradient(to right, #F29E18, #EF4444, transparent)',
  },
  {
    id: 'skin_void',
    naam: 'The Void',
  ...
  },
  {
    ...
    border: 'linear-gradient(135deg, #92400E, #F29E18, #92400E)',
    glowColor: 'rgba(245, 158, 11, 0.12)',
    background: 'linear-gradient(180deg, #0c0c0e 0%, #100c06 100%)',
    accent: '#F29E18',
    animated: false,
    innerBorder: 'rgba(242,158,24,0.06)',
    headerGradient: 'linear-gradient(90deg, #F29E18, transparent)',
  },
  {
    id: 'skin_og',
    naam: 'OG',
...
export function getUnlockedSkins(
  ...
  return CARD_SKINS.filter((skin) => {
    if (skin.unlockType === 'level') return level >= parseInt(skin.unlockRequirement)
