...
import { LayoutDashboard, User, Shield, LogOut, Menu, X, ShoppingBag, Coins, CreditCard } from 'lucide-react'
...
const NAV_ITEMS = [
  ...
  { href: '/dashboard/card-editor', label: 'Card Editor', Icon: CreditCard },
