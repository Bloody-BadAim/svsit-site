...
This project is indexed by GitNexus as **svsit-site** (2719 symbols, 4053 relationships, 101 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/svsit-site/context` | Codebase overview, check index freshness |
| `gitnexus://repo/svsit-site/clusters` | All functional areas |
| `gitnexus://repo/svsit-site/processes` | All execution flows |
| `gitnexus://repo/svsit-site/process/{name}` | Step-by-step execution trace |
